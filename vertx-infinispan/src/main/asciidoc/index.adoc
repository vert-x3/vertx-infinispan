...
Note that since Infinispan 16, the file location is `org/infinispan/configuration/default-jgroups-kubernetes.xml`.
[source,shell]
----
-Dvertx.jgroups.config=org/infinispan/configuration/default-jgroups-kubernetes.xml
----
