...
[source,kotlin]
----
var mgr = io.vertx.ext.cluster.infinispan.InfinispanClusterManager()
...
[source,kotlin]
----
var mgr = io.vertx.ext.cluster.infinispan.InfinispanClusterManager(cacheManager)
...
The readiness probe can be implemented with link:../../vertx-health-check/kotlin/[Vert.x Health Checks]:
...
After creation, it can be exposed over HTTP with a link:../../vertx-web/kotlin/[Vert.x Web] router handler:
...
[source,kotlin]
----
var infinispanAsyncMap = InfinispanAsyncMap.unwrap<Any, Any>(asyncMap)
