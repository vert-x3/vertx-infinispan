...
Infinispan uses Java's `ServiceLoader` mechanism to discover implementations of a couple classes at runtime.

You must configure your build tool to merge the following files when creating an executable uber JAR (also known as "fat" JAR):
...
<configuration>
  <transformers>
    <transformer implementation="org.apache.maven.plugins.shade.resource.AppendingTransformer">
      ...
      <resource>META-INF/services/org.infinispan.factories.impl.ModuleMetadataBuilder</resource>
    </transformer>
    <!-- ... -->
  </transformers>
  <!-- ... -->
...
If you use Gradle and the Gradle Shadow Plugin, make sure all service descriptors files are merged:
