...
If you are using Vert.x from the command line, the jar corresponding to this cluster manager (it will be named `vertx-infinispan-3.5.3.jar`
...
the artifact: `io.vertx:vertx-infinispan:3.5.3` in your project.
