...
If you are using Vert.x from the command line, the jar corresponding to this cluster manager (it will be named `vertx-infinispan-3.5.4.jar`
...
the artifact: `io.vertx:vertx-infinispan:3.5.4` in your project.
