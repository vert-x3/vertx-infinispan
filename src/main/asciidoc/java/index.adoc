...
If you are using Vert.x from the command line, the jar corresponding to this cluster manager (it will be named `vertx-infinispan-3.4.1-SNAPSHOT.jar`
...
the artifact: `io.vertx:vertx-infinispan:3.4.1-SNAPSHOT` in your project.
...
First, add the `org.infinispan:infinispan-cloud:9.0.0.CR3` dependency to your project.
